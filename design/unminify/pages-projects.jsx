                      ...
                      <>
                          ...
                          {shown < filtered.length && (
                              <div ref={sentinelRef} style={{ marginTop: "2rem", textAlign: "center" }}>
                                  <div
                                      className="row"
                                      style={{ justifyContent: "center", gap: "0.5rem", color: "var(--muted)" }}
                                  >
                                      <span
                                          className="skeleton"
          ...
          <section className="section" style={{ paddingTop: "9rem" }}>
              <div className="shell">
                  ...
                  <p
                      ...
                      style={{ fontSize: "1.2rem", lineHeight: 1.6, maxWidth: 760, "--reveal-delay": "0.1s" }}
                  >
                      {project.full}
                  </p>
                  ...
                  <div
                      ...
                      style={{ marginTop: "2rem", gap: "0.75rem", "--reveal-delay": "0.15s" }}
                  >
                  ...
                  >
                      {[
                          ...
                          <div
                              key={k}
                              style={{ padding: "1.5rem", borderRight: i < 3 ? "1px solid var(--border)" : "none" }}
                          >
                              <div
                                  className="mono muted"
                                  style={{
                  ...
                  >
                      <div>
                          ...
                          <p
                              className="text-2"
                              style={{ fontSize: "1.05rem", lineHeight: 1.75, marginBottom: "2rem" }}
                          >
                          ...
                          <p className="text-2" style={{ fontSize: "1.05rem", lineHeight: 1.75 }}>
                              Shipped on time, hit Lighthouse 95+, and the client team owns the codebase. Project is
                              still in active production at the time of writing.
                          </p>
                      </div>
                      <aside>
          ...
          <section className="section">
              <div className="shell">
                  <SectionHead
                      ...
                      sub="Other things I've shipped recently."
                  />
                  <div className="grid-3">
                      {!related
  ...
  return (
      <main className="page-anim">
          <PageIntro
              eyebrow="Blog"
              title="Field notes."
              sub="Stuff I've learned the hard way, written down so I don't forget. Mostly Laravel, Next.js, and devops."
          />
                  ...
                  {!pageData ? (
                      ...
                      <>
                          ...
                          {totalPages > 1 && (
                              <div
                                  className="row"
                                  style={{ justifyContent: "center", marginTop: "3rem", gap: "0.4rem" }}
                              >
                                  <button
                                      className="btn-icon"
                                  ...
                                  {[...Array(totalPages)].map((_, i) => (
                                      <button
                                          key={i}
                                          className={`tag ${page === i + 1 ? "tag-accent" : ""}`}
                                          onClick={() => setPage(i + 1)}
                                          style={{
                                              cursor: "pointer",
      ...
      <main className="page-anim">
          <article className="section" style={{ paddingTop: "9rem" }}>
              <div className="shell" style={{ maxWidth: 760 }}>
                  ...
                  <h1 className="h-1 reveal text-grad" style={{ marginBottom: "1.5rem", "--reveal-delay": "0.05s" }}>
                      {blog.title}
                  </h1>
                  <div
                  ...
                  >
                      ...
                      >
                          <Icon name="calendar" size={11} /> {blog.date}
                      </span>
                      <span
                          className="muted mono"
                          style={{ fontSize: "0.78rem", display: "flex", alignItems: "center", gap: "0.35rem" }}
                      >
                          <Icon name="clock" size={11} /> {blog.read}
                      </span>
                  </div>
                  ...
                  <div className="prose reveal" style={{ "--reveal-delay": "0.05s" }}>
                      <p>{blog.excerpt}</p>
                      <p>
                          This is a sample article body that would be rendered from MDX or a rich-text editor on the
                          live site. Headings, lists, code blocks, callouts and images all live here. The published
                          version is editable from the admin dashboard, with a Tiptap-style editor that supports
                          keyboard shortcuts, markdown paste, and inline images.
                      </p>

                      <h2>The pattern</h2>
                      <p>
                          Take any controller method that's grown beyond a single screen. Move it into a class. Inject
                          the dependencies. Now it's testable, reusable, and the route file stays scannable. That's
                          the whole pitch.
                      </p>
                      <pre>
  ...
  public function store(StorePost $action, StorePostRequest $req) {
      return $action->execute($req->validated());
                      ...
                      <ul>
                          ...
                          <li>
                              You can call actions from jobs, console commands, and tests with the same signature.
                          </li>
                      </ul>

                      <blockquote>
                          The best refactor is the one you don't have to do, because the structure made the right
                          shape obvious.
                      </blockquote>

                      <h2>What I'd do differently</h2>
                      <p>
                          Be ruthless about file naming — one verb, one noun. Don't reach for actions when a simple
                          service method will do; the goal is clarity, not pattern-purity. Keep your test boundary at
                          the action, not the route.
                      </p>

                      <p>
                          I've been running this pattern across every Laravel project I've touched in the last 12
                          months. It hasn't failed me yet.
                      </p>
                  </div>
                      ...
                      <div className="row" style={{ gap: "1rem", flexWrap: "wrap", justifyContent: "space-between" }}>
                          <div className="row" style={{ gap: "0.6rem" }}>
                              ...
                              {["twitter", "linkedin", "facebook"].map((s) => (
                                  <a key={s} href="#" className="btn-icon" aria-label={s}>
                                      <Icon name={s} size={13} />
                                  </a>
                              ))}
                          </div>
