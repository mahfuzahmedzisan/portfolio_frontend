    ...
    return (
        <div className="nav-wrap" style={{ top: scrolled ? "0.5rem" : "1rem" }}>
            <nav
                className="nav shell"
                style={{
                    padding: scrolled ? "0.55rem 0.85rem 0.55rem 1.25rem" : "0.7rem 0.85rem 0.7rem 1.25rem",
            ...
            >
                ...
                <ul className="nav-links">
                    {NAV_ITEMS.map((n) => (
                        <li key={n.href}>
                            <a href={n.href} className={`nav-link ${isActive(n.href) ? "active" : ""}`}>
                                {n.label}
                            </a>
                        </li>
                    ))}
        ...
        <div className="shell">
            <div className="footer-grid">
                <div className="footer-col">
                    ...
                    <p
                        className="text-2"
                        style={{ margin: "1rem 0 1.5rem", fontSize: "0.92rem", lineHeight: 1.65, maxWidth: 320 }}
                    >
                        {PROFILE.tagline}
                    </p>
...
function applyTweaks(t) {
    ...
    applyTheme(t.theme);
    try {
        localStorage.setItem("theme-mode", t.theme);
    } catch {}
...
const Router = ({ route, heroLayout }) => {
    ...
    return (
        <main className="shell page-anim" style={{ padding: "9rem 0 6rem", textAlign: "center" }}>
            ...
            <h1 className="h-display" style={{ margin: "1rem 0", fontSize: "clamp(3rem, 8vw, 7rem)" }}>
                Lost in the grid.
            </h1>
            <p className="text-2" style={{ maxWidth: 480, margin: "0 auto 2rem" }}>
                That route doesn't exist (yet). Let's get you home.
            </p>
